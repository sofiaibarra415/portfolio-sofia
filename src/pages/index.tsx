      ...
      <Container id="about">
        <div className="mt-6">
          ...
          <div className="md:pt-16 pt-8 flex flex-col items-center">
            ...
            I have been studying the world of Front-End web development for 3 years. I am currently studying a Bachelor's Degree in Computer Science, which gives me a solid foundation in programming fundamentals, algorithms and data structures. I finished my secondary studies last year, but I had the possibility of accessing different courses during my school years. This has allowed me to develop good skills in languages ​​such as Javascript and libraries such as React Js. I continue to complement my academic training with specialized courses in technologies such as React.js, JavaScript, Node.js and Angular.
            </p>
            <div>
              {disabled === false ? (
                <form
